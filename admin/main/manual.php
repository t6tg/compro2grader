        ...
        <div class="container">
            ...
            <table border="1">
                ...
                <tr>
                    ...
                    <?php } else {?>
                    <td><a target="_blank"
                            href="show.php?week=<?php echo $row_manual['week']; ?>&file=<?php echo $row_manual['username'] . _ . $row_manual['week']; ?>.<?php echo $parts[1]; ?>&type=img"><img
                                src="../../main/process/<?php echo $row_manual['file']; ?>" width="100px"></a></td>
                    <?php }?>
                    <td><?php echo $row_manual['week']; ?></td>
                    <td><a
                            href="manual.php?username=<?php echo $row_manual['username']; ?>&week=<?php echo $row_manual['week']; ?>&pass=1&file=<?php echo $row_manual['file']; ?>">Pass</a>
                    </td>
                    <td><a
                            href="manual.php?username=<?php echo $row_manual['username']; ?>&week=<?php echo $row_manual['week']; ?>&pass=0&file=<?php echo $row_manual['file']; ?>">No
                            Pass</a></td>
