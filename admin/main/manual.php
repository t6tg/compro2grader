        ...
        <table border="1">
            ...
            <?php while ($row_manual = mysqli_fetch_array($query_manual)) { ?>
                <tr>
                    ...
                    <?php if($parts[1] == "java"){ ?>
                        <td><a target="_blank" href="show.php?week=<?php echo $row_manual['week'] ?>&file=<?php echo  $row_manual['username'] ?>&type=java">
                        <img src="../../img/java.png" width="100px">
                        </a>
                    </td>
                    <?php }else {?>
                    <td><a target="_blank" href="show.php?week=<?php echo $row_manual['week'] ?>&file=<?php echo  $row_manual['username']._.$row_manual['week']; ?>.<?php echo $parts[1]?>&type=img"><img src="../../main/process/<?php echo $row_manual['file'] ?>" width="100px"></a></td>
                    <?php } ?>
