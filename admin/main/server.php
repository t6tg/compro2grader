        ...
        <form action="" method="post">
            <center>
                <table>
                    ...
                    <tr>
                        <td>&ensp;&ensp;<input type="radio" name="server" value="1"
                                <?php echo $sever_on; ?>>&ensp;&ensp;</td>
                        <td>&ensp;&ensp;<input type="radio" name="server" value="0"
                                <?php echo $sever_off; ?>>&ensp;&ensp;</td>
                    </tr>
                </table><br>
        ...
        <form action="" method="post">
            <center>
                <table>
                    ...
                    <tr>
                        <td>&ensp;&ensp;<input type="radio" name="ban" value="1" <?php echo $ban_on; ?>>&ensp;&ensp;
                        </td>
                        <td>&ensp;&ensp;<input type="radio" name="ban" value="0" <?php echo $ban_off; ?>>&ensp;&ensp;
                        </td>
                    </tr>
                </table><br>
