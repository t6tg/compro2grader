        ...
        <div class="container">
            ...
            <table width="25%">
                ...
                <?php while ($row_work = mysqli_fetch_array($query_work)) { ?>
                    <tr>
                        <td><?php echo '<a href="main/read.php?read='.$row_work['week'].'" style="color:black">'.$row_work['week'].'</a>'; ?></td>
                        <td>
                            <?php if ($row_work['status'] == 1) { ?>
                                
                                <a href="index.php?week=<?php echo $row_work['week'] ?>&status=0"><span style="color:green">on</span></a>
                            <?php } ?>
                            <?php if ($row_work['status'] == 0) { ?>
                                <a href="index.php?week=<?php echo $row_work['week'] ?>&status=1"><span style="color:red">off</span></a>
                            <?php } ?>
                        </td>
                        <td>
