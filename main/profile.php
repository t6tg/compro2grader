...
<div class="wrapper">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <?php while ($row = mysqli_fetch_array($result)) { ?>
          <li class="active" ><a><span><a class="menu-icon fa fa-book " href="index.php?week=<?php echo $week = $row['week'] ?>"><?php echo  "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>" . $week = $row['week'] . "</b>" ?></a></span></a></li>
        <?php } ?>
      ...
      <?php
            while ($row_file = mysqli_fetch_array($result_file)) { ?>
                ...
                ?>
                 <li class="active" ><a><span><a class="menu-icon fa fa-file-pdf-o " href="pdf.php?file=<?php echo $file ?>"><?php echo  "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>" . $file. "</b>" ?></a></span></a></li>
                <?php } ?>
      </ul>
      <!-- /.sidebar-menu -->
    </section>
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; <?php echo Date('Y'); ?><a href="https://fb.com/mjamesthanawat"> Thanawat Gulati</a>.</strong> All rights reserved.
  </footer>
